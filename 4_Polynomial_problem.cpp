...
// Polynomial Problem Not completed.From Guided path Coding Ninjas.
// This Program is taken from the discussion box.
...
int main() {    
    ...
    for(int i=0;i < count1; i++) {        
        cout<<"Enter degree at "<<i<<" for count1: ";
        cin >> degree1[i];
        // cout<<endl;
    }        
    
    for(int i=0;i < count1; i++) {     
        cout<<"Enter coeff. at "<<i<<" for count1: ";   
        cin >> coeff1[i];    
    }        
